...
public class Example4 {
    public static void main (String[] args) {
        try {
            File f1 = new File("C:\\Users\\tretyakov\\Desktop\\Example3.txt");
            f1.createNewFile();
            Scanner sc = new Scanner(System.in);
            DataOutputStream wr = new DataOutputStream(new FileOutputStream(f1.getAbsolutePath()));
            System.out.println("How much numbers u want to write in your file?");
            ...
            wr.flush();
            wr.close();
            File f2 = new File("C:\\Users\\tretyakov\\Desktop\\Example4.txt");
            f2.createNewFile();
